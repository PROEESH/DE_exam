...
CREATE OR REPLACE TABLE `voltaic-tooling-471807-t5.teams.teams` AS
SELECT team_id, team_name,team_country,team_founded FROM `voltaic-tooling-471807-t5.teams.teams_API2`
